...
function HeroSection() {
  ...
  <Row className='pdf-images'>
    <Col md={6} xs={6}>
      <div>
        <a href={Third} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
    ...
    <Col md={6} xs={6}>
      <div>
        <a href={Second} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
  ...
  <Row className='pdf-images mt-4'>
    <Col md={6} xs={6}>
      <div>
        <a href={Fourth} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
    ...
    <Col md={6} xs={6}>
      <div>
        <a href={First} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
  ...
  <Row className='pdf-images mt-4'>
    <Col md={6} xs={6}>
      <div>
        <a href={Five} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
    ...
    <Col md={6} xs={6}>
      <div>
        <a href={Six} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
  ...
  <Row className='pdf-images mt-4'>
    <Col md={6} xs={6}>
      <div>
        <a href={Eight} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
    ...
    <Col md={6} xs={6}>
      <div>
        <a href={Ten} style={{ color: 'black', textDecoration: 'none' }} className='fw-bold'>
          <div className="d-flex align-items-center">
